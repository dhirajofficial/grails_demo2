...
class gsp_grails_demo2index_gsp extends GroovyPage {
...
invokeTag('link','g',120,['controller':("user"),'action':("login")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1534904166751L
