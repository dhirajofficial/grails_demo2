...
class gsp_grails_demo2_useraddUser_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/user/addUser.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(16)
invokeTag('submitButton','g',70,['name':("Add User")],-1)
printHtmlPart(17)
})
invokeTag('form','g',71,['action':("insert"),'controller':("user")],2)
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1534997087788L
