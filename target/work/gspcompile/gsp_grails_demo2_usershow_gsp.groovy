...
class gsp_grails_demo2_usershow_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',28,['code':("user.userName.label"),'default':("User Name")],-1)
printHtmlPart(15)
...
printHtmlPart(20)
invokeTag('message','g',46,['code':("user.role.label"),'default':("Role")],-1)
printHtmlPart(21)
invokeTag('fieldValue','g',48,['bean':(userInstance),'field':("role")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (userInstance?.emailAddress)) {
printHtmlPart(22)
invokeTag('message','g',55,['code':("user.emailAddress.label"),'default':("Email Address")],-1)
printHtmlPart(23)
invokeTag('fieldValue','g',57,['bean':(userInstance),'field':("emailAddress")],-1)
printHtmlPart(16)
}
printHtmlPart(24)
createTagBody(2, {->
...
invokeTag('form','g',68,['url':([resource:userInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1534874627284L
