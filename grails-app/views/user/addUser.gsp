    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Database Operations <span class="caret"></span></a>
...
<div class="container">
    <g:form action="insert" controller="user">
        <fieldset>
            ...
            <g:submitButton name="Add User"></g:submitButton>
        </fieldset>
    </g:form>
</div>
